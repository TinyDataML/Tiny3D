...
def main():
    ...
    parser.add_argument('--pcd', default='test/test_model_ops/data/kitti/kitti_000008.bin', help='Point cloud file')
    parser.add_argument('--checkpoint', default='checkpoints/hv_pointpillars_secfpn_6x8_160e_kitti-3d-car_20220331_134606-d42d15ed.pth', help='Checkpoint file')
    parser.add_argument('--backend', default='onnxruntime', help='backend name')
    parser.add_argument('--output', default='pointpillars', help='backend name')
    parser.add_argument('--dataset', default='kitti', help='backend name')
    parser.add_argument('--model_name', default='pointpillars', help='backend name')
    parser.add_argument(
