...
## Introduction 
Product3D is a light weight **Performance Optimization System** for 3d object detection online/offline inference services product performance optimization. Through our Product3d users can easily get a **high accuracy and high speed** 3d object detection service/competetion result in a data-model double centeric ai and user-friendly web interface way.
