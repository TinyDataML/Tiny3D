...
from .wlop import weighted_local_optimal_projection
...
def lidar_filter(lidar_data, method, params):
    ...
    elif (method == "weighted_local_optimal_projection"):
        return weighted_local_optimal_projection(lidar_data, **params)
    else:
